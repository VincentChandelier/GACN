...
def main(argv):
    ...
    net = getmodel(args.model)
    print("Current compression model is {}".format(args.model))
    net = net.to(device)
    ...
    lr_scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[80], gamma=0.1, last_epoch=-1)
